...
Ziel: Die **State-Arten** und **abstrakten Konzepte** von frametrack mit **vereinfachten Code-Beispielen** nachvollziehen.
...
| --------------- | ---------------------------------------------- |
| `TrackingState` | `crates/frametrack-tracking/src/state.rs`      |
