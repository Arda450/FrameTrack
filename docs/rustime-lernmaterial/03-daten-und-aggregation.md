...
| **Segment** | Geschätzte Dauer, in der man beim _ersten_ Titel „geblieben“ ist |
...
Separates Tool füllt `frametrack.db` mit realistischen 2-Sekunden-Samples in Arbeitsblöcken (24 h).  
